...
public class AddToDoActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // ODO - Set up OnClickListener for the Reset Button
    final Button resetButton = (Button) findViewById(R.id.resetButton);
    resetButton.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
        // ODO - Reset data to default values
        mTitleText.setText("");
    ...
    submitButton.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        // ODO - Get the current Priority
        Priority priority = getPriority();
        // ODO - Get the current Status
        Status status = getStatus();
        // ODO - Get the current ToDoItem Title
        ...
        ToDoItem.packageIntent(data, titleString, priority, status,
            fullDate);
        // ODO - return data Intent and finish
